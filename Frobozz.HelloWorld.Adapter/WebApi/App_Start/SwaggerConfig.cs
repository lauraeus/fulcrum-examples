...
namespace Frobozz.HelloWorld.Adapter
{
    ...
    internal class SwaggerConfig
    {
                ...
                .EnableSwagger(c =>
                    {
                        ...
                        c.SingleApiVersion($"v1", "Frobozz.HelloWorld.Adapter");
        ...
        {
            return System.String.Format(@"{0}\bin\Frobozz.HelloWorld.Adapter.XML", System.AppDomain.CurrentDomain.BaseDirectory);
        }
    }
}
