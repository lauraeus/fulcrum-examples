...
namespace Xlent.Lever.Libraries2.MoveTo.Core.Crud.ServerTranslators.From
{
    ...
    where TModel : IValidatable
    {
        ...
        /// <inheritdoc />
        public ManyToOneServerTranslatorFrom(IManyToOneRelation<TModel, string> storage, string idConceptName, System.Func<string> getServerNameMethod, ITranslatorService translatorService)
