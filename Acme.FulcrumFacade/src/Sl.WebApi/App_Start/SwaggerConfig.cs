...
namespace Acme.FulcrumFacade.Sl.WebApi.App_Start
{
    public class SwaggerConfig
    {
        ...
        {
            return System.String.Format(@"{0}\bin\Acme.FulcrumFacade.Sl.WebApi.XML", System.AppDomain.CurrentDomain.BaseDirectory);
        }
    }
}
