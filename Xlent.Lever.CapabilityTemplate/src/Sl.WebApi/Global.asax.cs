...
using Xlent.Lever.CapabilityTemplate.CompositionRoot;
using Xlent.Lever.CapabilityTemplate.Sl.WebApi.App_Start;

namespace Xlent.Lever.CapabilityTemplate.Sl.WebApi
{
    /// <summary>
