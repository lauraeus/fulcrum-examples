...
namespace Xlent.Lever.CapabilityTemplate.Sl.WebApi.App_Start
{
    public class SwaggerConfig
    {
        ...
        {
            return System.String.Format(@"{0}\bin\Xlent.Lever.CapabilityTemplate.Sl.WebApi.XML", System.AppDomain.CurrentDomain.BaseDirectory);
        }
    }
}
