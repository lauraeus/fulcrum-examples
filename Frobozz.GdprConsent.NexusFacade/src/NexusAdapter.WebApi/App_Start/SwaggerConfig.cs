...
namespace Frobozz.GdprConsent.NexusAdapter.WebApi
{
    ...
    {
        /// <summary>
        /// Register the controllers to the swashbuckle NuGet package.
        /// </summary>
                ...
                .EnableSwagger(c =>
                    {
                        ...
                        // PersonsController will be listed before those from a CustomersController. This is typically
        ...
        {
            return System.String.Format(@"{0}\bin\Frobozz.GdprConsent.NexusAdapter.WebApi.xml", System.AppDomain.CurrentDomain.BaseDirectory);
        }
    }
}
